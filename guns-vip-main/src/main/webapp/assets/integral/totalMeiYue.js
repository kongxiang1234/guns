...
layui.use(['table', 'admin', 'ax', 'func','form','laydate'], function () {
    ...
    Integral.initColumn = function () {
        return [[
            ...
            {field: 'unit', sort: true, title: '所属单位'},
            {field: 'sjname', sort: true, title: '试卷名称'},
            {field: 'total', sort: true, title: '考试次数'},
            {field: 'avgScore', sort: true, title: '平均得分'},
            {field: 'mscore', sort: true, title: '最高得分'},
            {field: 'score', sort: true, title: '最低得分'},
            {field: 'avgranking', sort: true, title: '平均排名'}
        ]];
    };
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/practice/listMeiyue',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
