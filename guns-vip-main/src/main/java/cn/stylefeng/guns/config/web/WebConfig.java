...
public class WebConfig implements WebMvcConfigurer {
    ...
    public FilterRegistrationBean xssFilterRegistration() {
        ...
        xssFilter.setUrlExclusion(Arrays.asList("/notice/add", "/notice/update", "/excelExportDeploy/editItem", "/excelExportDeploy/addItem", "/management/addItem", "/management/editItem"
                , "/content/addItem", "/content/editItem", "/break/addItem", "/break/editItem"));
