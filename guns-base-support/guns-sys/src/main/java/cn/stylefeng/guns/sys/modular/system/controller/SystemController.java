...
public class SystemController extends BaseController {
     ...
     * @Date 2018/11/9 12:45 PM
     */
    @RequestMapping("/updateAvatarUser")
    @ResponseBody
    public Object updateAvatarUser(@RequestParam("fileId") String fileId,@RequestParam("userId") String userId) {
        if (ToolUtil.isEmpty(fileId)) {
            throw new RequestEmptyException("请求头像为空");
        }
        fileInfoService.updateAvatarUser(fileId,userId);
