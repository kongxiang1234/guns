...
public class DictController extends BaseController {
     ...
     */
    @ResponseBody
    @RequestMapping("/listDictsByName")
    public ResponseData listDictsByName(@RequestParam("dictTypeName") String dictTypeName) {
        List<Dict> dicts = this.dictService.listDictsByName(dictTypeName);
        return new SuccessResponseData(dicts);
    }
