...
public class ConstantFactory implements IConstantFactory {
   ...
   // private ContentMapper contentMapper = SpringContextHolder.getBean(ContentMapper.class);
    public static IConstantFactory me() {
        return SpringContextHolder.getBean("constantFactory");
    }

    @Override
    public String getContentname(Integer id) {
        /*Content user = contentMapper.selectById(id);
        if (user != null) {
