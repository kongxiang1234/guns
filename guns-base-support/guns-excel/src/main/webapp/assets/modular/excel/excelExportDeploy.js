layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    ExcelExportDeploy.initColumn = function () {
        return [[
            ...
            {field: 'template', sort: true, title: '模版文件', templet: function (d) {
                    var url = Feng.ctxPath + '/excelExportDeploy/download?fileFinalName=' + d.template;
                    return '<a style="color: #01AAED;" href="' + url + '">模板下载</a>';
                }},
